...
public class SwipeDismissListener implements RecyclerView.OnItemTouchListener {
     ...
     */
    public SwipeDismissListener(RecyclerView recyclerView, SwipeListener listener) {
